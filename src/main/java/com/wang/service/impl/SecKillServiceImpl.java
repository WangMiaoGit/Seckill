...
import com.wang.dao.SuccessKilledDao;
...
public class SecKillServiceImpl implements SecKillService {
    ...
    //加盐  混淆MD5
    private final String slat = "4534#%#$%#$hfghbfxg12198426";
    ...
    public SeckillExecution executeSeckill(long seckillId, long userPhone, String md5)
        ...
        try {
            //记录购买行为
            int insertCouint = successKilledDao.insertSuccessKilled(seckillId, userPhone);
